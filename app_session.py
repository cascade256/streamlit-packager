...
from streamlit import __version__, caching, legacy_caching
...
from streamlit.proto.NewSession_pb2 import Config, CustomThemeConfig
from streamlit.session_data import SessionData
from streamlit.script_request_queue import RerunData, ScriptRequest, ScriptRequestQueue
from script_runner import ScriptRunner, ScriptRunnerEvent
...
class CustomAppSession:
    ...
    def request_rerun(self, client_state: Optional[ClientState]) -> None:
        ...
        """
        if client_state:
            print(client_state.query_string)
    ...
    def _enqueue_new_session_message(self) -> None:
        ...
        imsg.user_info.installation_id = ""
        # imsg.installation_id = ""
...
def _populate_config_msg(msg: Config) -> None:
    ...
    msg.gather_usage_stats = False
    msg.max_cached_message_age = 1000
    msg.mapbox_token = ""
    msg.allow_run_on_save = False
    msg.hide_top_bar = False
