...
def get_cefpython3_datas():
    ...
    for filename in os.listdir(CEFPYTHON3_DIR):
        ...
        if extension in \
            ...
            ret.append((os.path.join(CEFPYTHON3_DIR, filename), os.path.join("cefpython3", cefdatadir)))
    ...
    if is_darwin:
        ...
        for filename in os.listdir(locales_dir):
            ...
            ret.append((os.path.join(locales_dir, filename),
                        os.path.join("cefpython3", cefdatadir, "locales")))
        ...
        if os.path.isdir(swiftshader_dir):
            for filename in os.listdir(swiftshader_dir):
                ...
                ret.append((os.path.join(swiftshader_dir, filename),
                            os.path.join("cefpython3", cefdatadir, "swiftshader")))
    return ret
...
if is_darwin or is_linux:
    binaries = [(os.path.join(CEFPYTHON3_DIR, "subprocess"), "cefpython3")]
elif is_win:
